                        ...
                        <div class="row_group">
                            <div class="join_row">
                                ...
                                <span class="ps_box int_id">
                                    <form:input type="text" id="id" path="id" class="int" title="ID" maxlength="20" required="required"/>
                                </span>
                            </div>
                            <div class="join_row">
                                <h3 class="join_title">
                                ...
                                <span class="ps_box int_pass">
                                    <form:input type="password" id="pswd1" path="password" class="int" title="비밀번호 입력" maxlength="20" required="required"/>
                                </span>
                                <h3 class="join_title">
                                    <label for="pswd2">비밀번호 재확인</label>
                                </h3>
                                <span class="ps_box int_pass_check" id="pswd2Img">
                                    <form:input type="password" id="pswd2" path="confirmPassword" class="int" title="비밀번호 재확인 입력" maxlength="20" required="required"/>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row_group">
                        <div class="join-row">
                            ...
                            <span class="ps_box box_right_space">
                                <form:input type="text" id="name" path="name" title="이름" class="int" maxlength="40" required="required"/>
                            </span>                            
                        </div>
                        <div class="join_row join_birthday">
                            ...
                            <div class="bir_wrap">
                                <div class="bir_yy">
                                    <span class="ps_box">
                                        <form:input type="date" path="birth" aria-label="년(4자)" class="int" required="required"/>
                                    </span>
                                </div> 
                            </div>
                            <div class="join_row join_sex">
                                ...
                                <div class="ps_box gender_code">
                                    <form:select id="gender" path="gender" class="sel" aria-label="성별" required="required">
