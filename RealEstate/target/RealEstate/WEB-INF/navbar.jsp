                ...
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                  ...
                  <li class="has-children">
                    ...
                    <ul class="dropdown arrow-top" style="padding-top:20px;">
                      ...
                      <li><a href="/RealEstate/login">매물 조회</a></li>
                    </ul>
                   </c:if>
                   <c:if test="${!empty authInfo }">
                    <a href="/RealEstate/Add_property">매물 등록</a>
                    <ul class="dropdown arrow-top" style="padding-top:20px;">
                      <li><a href="/RealEstate/Add_property">매물 등록</a></li>
                      <li><a href="/RealEstate/List_property">매물 조회</a></li>
