        ...
        <ul class="slidelist">
          <li>
                <div class="slide_content" style="display: inline-block; position: relative; ">
                  ...
                  transform: translate(-50%,-50%);
                  text-align: center;">
                    <span class="d-inline-block bg-success text-white px-3 mb-3 property-offer-type rounded" style=" padding-top: 2px; padding-bottom: 2px;">창원시 부동산 </span>
                    <h1 style="font-weight: bold; font-size: 70px; color: rgba(255, 255, 255, 0.822);">어떤 집을 찾고 계세요?</h1>
                    <p class=""><strong class="h2 text-success font-weight-bold" style="font-family: 'Jua', sans-serif;">FIND YOUR SWEET HOME <BR> WITH HOMELAND.</strong></p>
                    <p><a href="#" style="marin-top:25px;" class="btn btn-white btn-outline-white py-3 px-5 rounded-0 btn-2" >Go to Search</a></p>
                  </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                  <div class="property-entry h-100">
                    ...
                    <c:if test="${!empty authInfo.id}">
                     <a href="./member/like?address=${propertyList.address}" class="property-favorite">
                     <i class="fa-solid fa-heart" style="color: black; font-size: 25px; display: inline-block; padding-top: 12px;"></i></a>
                    </c:if> 
                    <c:if test="${empty authInfo.id}">
                      <a href="#" class="property-favorite" onclick="message();">
                      <i class="fa-solid fa-heart" style="color: black; font-size: 25px; display: inline-block; padding-top: 12px;"></i></a>
                    </c:if> 
                      <h2 class="property-title"><a href="/RealEstate/property_details?address=${propertyList.address}">${propertyList.location}</a></h2>
